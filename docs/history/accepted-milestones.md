...
- one pinned root-attached QEMU USB device enumerated through that xHCI base
  ...
  polling and five EP0 control transfers, exact attachment/interfront/endpoint
...
also retain the fixed configuration/interfront/endpoint/descriptor maxima,
...
oversized descriptors, exhausted interfront/endpoint/record capacities,
...
finite signs, sealed boot provenance, and xHCI/device/interfront/endpoint bases.
...
xHCI/device/interfront/endpoint bases. Native Patchbay consumes real
