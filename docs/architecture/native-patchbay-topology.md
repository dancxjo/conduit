...
snapshot's own evidence capacity and visible-gap count are shown separately.
...
availability observation remain separate fields. Exact provider instance,
...
compatibility matching, planning, selection, deployment, or authority action.
