...
| [`firmware/conduit-pico-w-signal/fabrication/xtask/serial.rs`](file:///home/dancxjo/src/conduit/firmware/conduit-pico-w-signal/fabrication/xtask/serial.rs) | 599 | review | target-owned Pico serial communication and inline contract tests | Pico fabrication command implementation reached through the `cargo xtask` entrance | Low |
