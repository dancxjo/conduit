# Scoped authority, effects, grants, and sensitivity version 1
...
Constraints are references by stable ID and semantic hash. Version 1 requires
...
At most eight constraints are accepted by the portable v1 descriptor.
...
`conformance/c2/authority-v1.tsv` freezes allow, missing-grant denial,
