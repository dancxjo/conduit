# Composable HTTP serving profile version 1
...
Version 1 defines domain-owned type contracts for request head, bounded body
...
`conduit.resolved-http-service/v1` pins:
...
Accordingly, version 1 reports the current constrained reference as
...
The normative fixture is `conformance/c5/http-serving-v1.json`. It contains 49
