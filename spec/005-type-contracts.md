# Domain-owned type contracts and registry current form

Status: normative current contract

Type-contract reference schema marker: `0`
...
Specification
[`027-implicit-satisfaction.md`](027-implicit-satisfaction.md) extends
...
the current comparison strategies or make structural comparison a fallback.
...
`conformance/c2/type-contract.tsv` is normative. It covers exact nominal
...
| TYP-012 | Keep provider loading and language bindings outside current form |
