...
**HZD-016.** Execution-plan schema 13 stores an optional `PlanHazardClosure`
containing the epoch, exact closure subject, policy, flow bindings, permits, and
decision identity. Hosted governed plans use
`conduit.execution-plan/v6`. Earlier plan-v3 through plan-v12 identities remain
...
**HZD-018.** `conformance/c2/hazard-closure-v1.json` contains 22 independently
