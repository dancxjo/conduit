# Allocator-free embedded execution profile version 1
...
`conduit/embedded-execution-profile` schema 1 pins finite maxima for:
...
The reference fixture emits a normal capability-report schema 2 with:
...
`conformance/c5/embedded-rp2040-v1.json` contains independently executed
...
reservation before host effects. `conformance/c5/rp2040-budgets-v1.json` owns
