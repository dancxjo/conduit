# Implicit contract satisfaction and structural proof version 1

Status: stable

Satisfaction proof schema version: 1

ExecutionPlan satisfaction binding schema version: 7
...
`conduit/satisfaction-proof` schema 1 contains:
...
`validate_port_satisfaction_proof` cross-checks these facts against the frozen
...
A schema-7 cord whose exact type references differ is runnable only with one
...
Schemas 1 through 6 retain their frozen identity algorithms. They have no
satisfaction-proof collection. Adding one to an older schema is rejected.
...
`conformance/c2/implicit-satisfaction-v1.json` freezes structural and nominal
...
and plan-v1 through plan-v6 contracts retain their frozen meaning. This
...
| SAT-014 | Preserve frozen nominal, opaque, migration, and plan-v1 through plan-v6 behavior |
