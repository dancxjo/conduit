# Untrusted boundary hardening current form
...
path-bearing package entries are not supported in package current form, so an
...
| Implementation kind | Honest current form isolation statement |
| --- | --- |
