# Directional compatibility and migration current form

Status: normative current contract

Compatibility algebra schema marker: `0`
...
current form defines these directional questions:
...
Specification
[`027-implicit-satisfaction.md`](027-implicit-satisfaction.md) retains
this three-outcome algebra and exact direction in a canonical provider proof.
It does not add a Boolean compatibility path or reinterpret any current
...
- `conformance/c1/compatibility.tsv` for exact, backward, forward,
  incompatible, and indeterminate record-schema decisions; and
- `conformance/c1/migration.tsv` for accepted, mismatched,
...
current form reason spellings and class meanings are stable. New reason variants
