# Bounded FlowPolicy algebra version 1

Status: stable

FlowPolicy algebra version: 1
...
Version 1 blocking fairness is FIFO. A blocked producer retains its offered
...
For capacity 2 containing `[a,b]`, arrival `c` has exactly these version 1
results:
...
`conformance/c2/flow-policy-v1.tsv` freezes the full `[a,b] + c` transition for
