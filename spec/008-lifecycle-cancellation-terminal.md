# Lifecycle, cancellation, and terminal semantics current form

Status: normative current contract

Lifecycle algebra schema marker: `0`
...
`conformance/c2/lifecycle.tsv` freezes positive and negative node,
composite, run, and cord transitions.
`conformance/c2/terminal-races.tsv` freezes required race outcomes, queue
...
| TRM-001 | Resolve races by the current precedence table |
