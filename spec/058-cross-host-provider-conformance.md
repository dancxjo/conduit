# Cross-host provider and extension conformance current form

Status: candidate normative C5 contract. The fixture
`conformance/c5/cross-host-provider-conformance.json` exercises HCF-001
through HCF-009.
...
`conduit.host-conformance-report` is a bounded presentation document.
