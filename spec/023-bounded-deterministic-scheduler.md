# Bounded deterministic scheduler contract current form

Status: C4 normative portable contract

Scheduler contract schema marker: `0`
...
current pool source or lowering fields.
...
current form has one scheduling discipline: bounded round robin.
...
`conformance/c4/bounded-scheduler.json` freezes 32 positive, negative,
