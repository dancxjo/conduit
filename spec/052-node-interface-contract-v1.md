# Named node-interface contract version 1

Status: stable

NodeInterfaceContract descriptor schema version: 1

NodeInterface satisfaction proof schema version: 1
...
The descriptor kind is `conduit/node-interface-contract`, schema version 1.
...
Version 1 permits at most 64 port members and 16 non-port requirements. The
...
Interface revisions have distinct exact identities. Version 1 defines no
...
`conduit/node-interface-satisfaction-proof` schema 1 retains:
...
`conformance/c2/node-interface-v1.json` freezes exact and refined success,
...
| NIF-014 | Preserve all frozen TypeContract, PortContract, NodeContract, composite, satisfaction, and plan identities |
