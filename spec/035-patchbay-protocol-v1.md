# Patchbay authoring and observation protocol version 1
...
revision, expected presentation revision, and ordered operations. The v1
...
`conformance/c8/patchbay-protocol-v1.json` covers presentation-only identity,
