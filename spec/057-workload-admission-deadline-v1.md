# Workload admission and deadline guarantees version 1
...
Execution-plan schema 19 may pin a `PlanWorkload` to an exact service identity
...
Task ceilings include threads. Version 1 exposes no implicit priority or
