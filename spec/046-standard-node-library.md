# Standard node library contract current form
...
- STD-013: canonical library identities are domain-first paths with no displaced rewrite.
...
network contracts. `conformance/c4/standard-catalog.json` maps every
