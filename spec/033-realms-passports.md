# Realms, entity passports, and membership lifecycle current form

Status: candidate normative C2/C4 contract. This specification is additive to
the current authority, evidence, Resonance, artifact, host-report, and plan
schemas. `conformance/c2/realms-passports.json` is the normative fixture.
...
`EventAuthorship` extends a Resonance envelope without modifying current
...
Capability-report current schema consumes this boundary through an identified
