# Conduit structured diagnostics version 1
...
Version 1 adapters provide actionable fixes for at least these common mistakes:
...
```json
{"schema_version":1,"code":"CND-SRC-001","severity":"error","message":"expected `->`","primary":{"document_id":"stdin","content_hash":"sha256:...","byte_start":19,"byte_end":20,"line":2,"column":12,"end_line":2,"end_column":13}}
```
...
`conformance/c3/diagnostics-v1.json` is normative. Its cases cover:
