...
pub const NEXT_KEY_EVENT_HOST_CALL_CONTRACT: &str = "conduit.host/input-next-key-event@1";
...
pub fn next_key_event_host_call_requirement() -> HostCallRequirement {
    HostCallRequirement {
        contract_id: HostCallContractId::from(NEXT_KEY_EVENT_HOST_CALL_CONTRACT),
...
pub fn hosted_keyboard_offer(capability: &str, artifact: &str) -> CapabilityOffer {
    BackOfferBuilder::new(
        ...
        Back {
            ...
            host_calls: vec![next_key_event_host_call_requirement()],
...
mod tests {
    ...
    fn offer_preserves_portable_front_and_bounded_effect() {
        ...
        assert_eq!(offer.host_calls[0].maximum_output_bytes, 3);
