...
pub const AUDIO_CONVERT_PCM_MAXIMUM_INPUT_BYTES: u32 =
...
pub const AUDIO_CONVERT_PCM_MAXIMUM_OUTPUT_BLOCKS: u16 =
    (AUDIO_CONVERT_PCM_INPUT_MAXIMUM_BYTES / 2)
        .div_ceil(AUDIO_CONVERT_PCM_INPUT_FRAMES_PER_BLOCK as u32) as u16;
...
pub fn audio_convert_pcm_profile_offer() -> CapabilityOffer {
    ...
    CapabilityOffer {
        ...
        kind_id: contract.kind_id,
        kind_contract_revision: KindContractRevision::from(
            conduit_semantic_catalog::AUDIO_CONVERT_PCM_PROFILE_REVISION,
        ),
        inputs: contract.inputs,
        outputs: contract.outputs,
        implementation: implementation(
            AUDIO_CONVERT_PCM_PROFILE,
...
mod tests {
    ...
    fn sound_offers_preserve_portable_faces_and_exact_effects() {
        ...
        let conversion = audio_convert_pcm_profile_offer();
        assert_eq!(
            conversion.inputs,
