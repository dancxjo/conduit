...
pub const RECORD_DELIVERY_STATUS_HOST_CALL: &str = "conduit.host/record-delivery-status@1";
    ...
    BackOfferBuilder::new(
        ...
        Back {
            ...
            host_calls: vec![HostCallRequirement {
                contract_id: HostCallContractId::from(RECORD_DELIVERY_STATUS_HOST_CALL),
