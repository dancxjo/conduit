...
pub(super) struct ImageTextRecordBack {
    pending: bool,
    complete: bool,
}

impl<const PORTS: usize> StepBack<PORTS> for ImageTextRecordBack {
...
fn prepare(
    ...
    validate(placement)?;
    Ok(InstalledBack::ImageTextRecord(ImageTextRecordBack {
        pending: false,
        complete: false,
    }))
}
