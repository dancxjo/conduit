...
pub(super) static STATE_TOGGLE_FACTORY: BackFactory = BackFactory {
    implementation_id: conduit_std_offers::STATE_TOGGLE_IMPLEMENTATION,
    budget: state_toggle_budget,
    prepare: prepare_state_toggle,
};

pub(super) struct StateToggleBack {
    values: Vec<ValueRef>,
    next: usize,
    initial_emitted: bool,
}

impl<const PORTS: usize> StepBack<PORTS> for StateToggleBack {
...
impl StateToggleBack {}

fn state_toggle_budget(placement: &PlannedGear) -> Result<BackBudget, String> {
...
fn prepare_state_toggle(
    ...
    Ok(InstalledBack::StateToggle(StateToggleBack {
        values: admitted,
        next: 0,
...
mod tests {
    ...
    fn operation(initial: bool) -> StateToggleBack {
