...
#[cfg(test)]
mod tests;
use super::super::back::{BackBudget, BackFactory, InstalledBack};
...
pub(crate) static FACTORY: BackFactory = BackFactory {
    implementation_id: conduit_std_offers::button::IMPLEMENTATION,
    budget,
    prepare,
};

pub(crate) struct ButtonBack {
    empty: ValueRef,
    next: u32,
...
fn prepare(
    ...
    Ok(InstalledBack::ButtonInput(ButtonBack {
        empty,
        next: 0,
        pending: None,
        terminal: false,
