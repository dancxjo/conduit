...
pub(super) struct MicrophoneClipBack {
    pending: bool,
    emitted: bool,
}

impl<const PORTS: usize> StepBack<PORTS> for MicrophoneClipBack {
...
fn prepare(
    ...
    validate(placement)?;
    Ok(InstalledBack::MicrophoneClip(MicrophoneClipBack {
        pending: false,
        emitted: false,
    }))
}
