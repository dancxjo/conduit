...
impl Operation for InstalledOperation {
    ...
    fn start(&mut self) -> OperationAction {
        match self {
            ...
            Self::WavArtifact(operation) => operation.start(),
            ...
            Self::RecognizedTurnCommit(operation) => operation.start(),
            Self::SpeechWindowToClip(operation) => operation.start(),
            Self::SpeechResultToEventStream(operation) => operation.start(),
            Self::HousePrompt(operation) => operation.start(),
            Self::BodyChatPrompt(operation) => operation.start(),
            Self::BodyConversationContext(operation) => operation.start(),
            Self::LocalModel(operation) => operation.start(),
            Self::LocalVision(operation) => operation.start(),
            Self::ModelText(operation) => operation.start(),
            Self::GeneratedSpeechCommit(operation) => operation.start(),
    ...
    fn resume(&mut self, input: OperationInput) -> OperationAction {
        match (self, input) {
            ...
            (Self::WavArtifact(operation), input) => operation.resume(input),
            ...
            (Self::RecognizedTurnCommit(operation), input) => operation.resume(input),
            (Self::SpeechWindowToClip(operation), input) => operation.resume(input),
            (Self::SpeechResultToEventStream(operation), input) => operation.resume(input),
            (Self::HousePrompt(operation), input) => operation.resume(input),
            (Self::BodyChatPrompt(operation), input) => operation.resume(input),
            (Self::BodyConversationContext(operation), input) => operation.resume(input),
            (Self::LocalModel(operation), input) => operation.resume(input),
            (Self::LocalVision(operation), input) => operation.resume(input),
            (Self::ModelText(operation), input) => operation.resume(input),
            (Self::GeneratedSpeechCommit(operation), input) => operation.resume(input),
    ...
    fn advance(&mut self) -> OperationAction {
        match self {
            ...
            Self::WavArtifact(_) => OperationAction::Await,
            ...
            Self::RecognizedTurnCommit(operation) => operation.advance(),
            Self::SpeechWindowToClip(operation) => operation.advance(),
            Self::SpeechResultToEventStream(operation) => operation.advance(),
            Self::HousePrompt(operation) => operation.advance(),
            Self::BodyChatPrompt(operation) => operation.advance(),
            Self::BodyConversationContext(operation) => operation.advance(),
            Self::LocalModel(operation) => operation.advance(),
            Self::LocalVision(operation) => operation.advance(),
            Self::ModelText(operation) => operation.advance(),
            Self::GeneratedSpeechCommit(operation) => operation.advance(),
