...
pub(super) struct TypedRecordBack {
    pending: bool,
    complete: bool,
}

impl<const PORTS: usize> StepBack<PORTS> for TypedRecordBack {
...
fn prepare(
    ...
    validate(placement)?;
    Ok(InstalledBack::TypedRecord(TypedRecordBack {
        pending: false,
        complete: false,
    }))
}
