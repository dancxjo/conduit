...
use super::flow_pressure_operations::{
    FLOW_BACKPRESSURE_FACTORY, FLOW_COALESCE_LATEST_FACTORY,
};
...
const FACTORIES: &[&InstalledFactory] = &[
    ...
    &TEXT_SUBMIT_FACTORY,
    &TEXT_MORSE_FACTORY,
    &TEXT_CHARACTERS_FACTORY,
    &MORSE_LOOKUP_FACTORY,
    &MORSE_INTERSPERSE_FACTORY,
    &MORSE_FLATTEN_FACTORY,
