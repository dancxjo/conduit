...
pub(super) static MUSIC_SYNTH_FACTORY: BackFactory = BackFactory {
...
pub(super) struct MusicSynthBack {
...
impl<const PORTS: usize> StepBack<PORTS> for MusicSynthBack {
...
fn prepare(
    ...
    budget(placement)?;
    Ok(InstalledBack::MusicSynth(MusicSynthBack {
        pending: None,
        input: None,
        next_request: 0,
        closed: [false; 3],
