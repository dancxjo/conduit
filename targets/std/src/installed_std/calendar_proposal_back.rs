...
pub(super) struct CalendarProposalBack {
    result: ValueRef,
    emitted: bool,
}

impl<const PORTS: usize> StepBack<PORTS> for CalendarProposalBack {
...
fn prepare(
    ...
    Ok(InstalledBack::CalendarProposal(CalendarProposalBack {
        result,
        emitted: false,
    }))
}
