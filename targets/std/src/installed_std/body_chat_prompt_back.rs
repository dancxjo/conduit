...
pub(super) struct BodyChatPromptBack {
...
impl<const PORTS: usize> StepBack<PORTS> for BodyChatPromptBack {
...
fn prepare(
    ...
    validate(placement)?;
    Ok(InstalledBack::BodyChatPrompt(BodyChatPromptBack {
        pending: None,
        next_request: 0,
        queued_human: None,
        emit_human: false,
