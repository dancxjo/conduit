...
pub(super) struct KeyboardInputBack {
...
impl<const PORTS: usize> StepBack<PORTS> for KeyboardInputBack {
    fn step(
        &mut self,
        io: &mut StepIo<PORTS>,
...
fn prepare(
    ...
    Ok(InstalledBack::KeyboardInput(KeyboardInputBack {
        empty_input,
        pending: None,
        next_request: 0,
        emitted: false,
