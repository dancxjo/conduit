...
impl<const PORTS: usize> StepBack<PORTS> for NavigationBack {
...
fn prepare(
    ...
    validate(placement)?;
    Ok(InstalledBack::Navigation(NavigationBack {
