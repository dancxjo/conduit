...
pub(super) use conduit_semantic_catalog::FinalNormalizedPatternBack;
...
fn prepare(
    ...
    Ok(InstalledBack::FinalNormalizedPattern(
        FinalNormalizedPatternBack::new(validate(placement)?),
    ))
}
