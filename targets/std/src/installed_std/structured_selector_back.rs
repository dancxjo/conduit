...
pub(super) use conduit_semantic_catalog::StructuredSelectorBack;
...
fn prepare(
    ...
    budget(placement)?;
    Ok(InstalledBack::StructuredSelector(
        StructuredSelectorBack::new(MAXIMUM_STRUCTURED_CANONICAL_BYTES as u32),
    ))
}
