...
pub(super) struct RhythmCompareBack {
...
impl<const PORTS: usize> StepBack<PORTS> for RhythmCompareBack {
...
fn prepare(
    ...
    Ok(InstalledBack::RhythmCompare(RhythmCompareBack {
        pending: None,
        next_request: 0,
        drain_marker,
...
#[cfg(test)]
#[path = "rhythm_compare_back_tests.rs"]
mod tests;
