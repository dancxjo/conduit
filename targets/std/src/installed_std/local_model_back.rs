...
pub(super) static LOCAL_MODEL_FACTORY: BackFactory = BackFactory {
    implementation_id: conduit_ai::LOCAL_MODEL_IMPLEMENTATION,
    budget,
    prepare,
};

pub(super) struct LocalModelBack {
...
impl<const PORTS: usize> StepBack<PORTS> for LocalModelBack {
...
fn prepare(
    ...
    validate(placement)?;
    Ok(InstalledBack::LocalModel(LocalModelBack {
...
mod tests {
    ...
    fn streaming_operation_pulls_one_chunk_only_after_prior_delivery() {
        let mut operation = LocalModelBack {
