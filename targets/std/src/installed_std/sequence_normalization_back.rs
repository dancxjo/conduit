...
pub(super) struct SequenceNormalizationBack {
    pending: bool,
    completed: bool,
}

impl<const PORTS: usize> StepBack<PORTS> for SequenceNormalizationBack {
...
impl SequenceNormalizationBack {}
...
fn prepare(
    ...
    budget(placement)?;
    Ok(InstalledBack::SequenceNormalization(
        SequenceNormalizationBack {
            pending: false,
            completed: false,
        },
    ))
