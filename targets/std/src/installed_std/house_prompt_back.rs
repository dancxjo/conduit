...
pub(super) struct HousePromptBack {
    seen: [bool; 2],
    closed: [bool; 2],
...
impl<const PORTS: usize> StepBack<PORTS> for HousePromptBack {
...
fn prepare(
    ...
    validate(placement)?;
    Ok(InstalledBack::HousePrompt(HousePromptBack {
        seen: [false; 2],
        closed: [false; 2],
        pending: None,
        deferred: None,
