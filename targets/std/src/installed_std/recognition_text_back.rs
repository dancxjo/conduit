...
pub(super) struct RecognitionTextBack {
...
impl<const PORTS: usize> StepBack<PORTS> for RecognitionTextBack {
...
fn prepare(
    ...
    validate(placement)?;
    Ok(InstalledBack::RecognitionText(RecognitionTextBack {
        pending: None,
        next_request: 0,
        emitted: false,
