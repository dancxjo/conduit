...
pub(super) struct TimedPatternBack {
    pending: Option<RequestId>,
    completed: bool,
}

impl<const PORTS: usize> StepBack<PORTS> for TimedPatternBack {
...
fn prepare(
    ...
    budget(placement)?;
    Ok(InstalledBack::TimedPattern(TimedPatternBack {
        pending: None,
        completed: false,
    }))
}
