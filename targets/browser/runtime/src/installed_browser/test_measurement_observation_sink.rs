//! Exact MeasurementSample observation fixture, excluded from production installations.
...
pub(crate) const KIND: &str = "conduit-test/measurement-observation-sink";
...
pub(crate) fn offer() -> CapabilityOffer {
    CapabilityOffer {
        ...
        inputs: vec![PortDescriptor {
            ...
            value_kind: conduit_data::measurement_sample_type()
                .profile()
                .unwrap()
                .value_kind()
                .clone(),
        ...
        host_operations: vec![HostOperationRequirement {
            contract_id: "conduit-test/measurement-observation-output".into(),
