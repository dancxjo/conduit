//! Typed path observation fixture, excluded from production installations.
...
pub(crate) const KIND: &str = "conduit-test/stroke-sink";
...
pub(crate) fn offer() -> CapabilityOffer {
    CapabilityOffer {
        ...
        inputs: vec![PortDescriptor {
            port_id: port_id("stroke"),
            value_kind: conduit_presentation::path2_type(4)
                .unwrap()
                .profile()
                .unwrap()
                .value_kind()
