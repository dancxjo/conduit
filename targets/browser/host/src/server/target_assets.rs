...
pub(super) fn response(request: Option<&str>) -> Option<(&'static str, &'static [u8])> {
    ...
    let body: &[u8] = match request? {
        "GET /targets/rp2040/deployment/browser/index.mjs HTTP/1.1" => RP2040_INDEX,
        "GET /targets/rp2040/deployment/browser/deployment.mjs HTTP/1.1" => RP2040_DEPLOYMENT,
        "GET /targets/rp2040/deployment/browser/picoboot.mjs HTTP/1.1" => RP2040_PICOBOOT,
        "GET /targets/rp2040/deployment/browser/uf2.mjs HTTP/1.1" => RP2040_UF2,
        "GET /targets/rp2040/deployment/browser/bootsel.mjs HTTP/1.1" => RP2040_BOOTSEL,
        "GET /targets/rp2040/deployment/browser/spawn.mjs HTTP/1.1" => RP2040_SPAWN,
        "GET /targets/rp2040/deployment/browser/fabrication.mjs HTTP/1.1" => RP2040_FABRICATION,
        ...
        "GET /targets/esp32/deployment/browser/index.mjs HTTP/1.1" => ESP32_INDEX,
        "GET /targets/esp32/deployment/browser/deployment.mjs HTTP/1.1" => ESP32_DEPLOYMENT,
        "GET /targets/esp32/deployment/browser/image.mjs HTTP/1.1" => ESP32_IMAGE,
        "GET /targets/esp32/deployment/browser/md5.mjs HTTP/1.1" => ESP32_MD5,
        "GET /targets/esp32/deployment/browser/reset.mjs HTTP/1.1" => ESP32_RESET,
        "GET /targets/esp32/deployment/browser/rom-loader.mjs HTTP/1.1" => ESP32_ROM_LOADER,
        "GET /targets/esp32/deployment/browser/slip.mjs HTTP/1.1" => ESP32_SLIP,
        _ => return None,
    };
