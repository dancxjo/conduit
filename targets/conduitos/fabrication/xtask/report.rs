...
pub struct GuestUsbSign {
    ...
    pub first_interfront_id: String,
    pub first_interfront_number: u8,
    pub first_interfront_alternate: u8,
    pub first_interfront_class: u8,
    pub first_interfront_subclass: u8,
    pub first_interfront_protocol: u8,
