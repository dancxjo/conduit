...
pub(super) fn execute(opts: &GlobalOpts) -> Result<(), ConduitosError> {
    ...
    .map_err(io_error)?;
    let gallery = r#"<!doctype html><meta charset="utf-8"><title>ConduitOS default graphical profile</title><style>body{background:#0f1720;color:#e1e8f0;font:18px system-ui;max-width:1100px;margin:48px auto}img{max-width:100%;border:1px solid #536b80}a{color:#53b2ff}</style><h1>Default graphical profile</h1><p>Development image · freestanding emulator evidence. These are ordinary shell surfaces from the canonical live ISO, not physical or stable acceptance.</p><p><a href="graphical-profile-proof.json">Profile and image proof</a> · <a href="journey-frames/manifest.json">Exact screenshot provenance</a></p><h2>First boot</h2><img src="journey-frames/front-door-ready.png" alt="Default Crèche typography and focused name field"><h2>Tour and code</h2><img src="journey-frames/tour-patchbay-open.png" alt="Tour prose, source code, and native graph"><h2>Hover and selection</h2><img src="journey-frames/pointer-selected.png" alt="Selected Gear and retained Inspector"><h2>Focused Inspector</h2><img src="journey-frames/inspector-focused.png" alt="Inspector fields with keyboard focus">"#;
