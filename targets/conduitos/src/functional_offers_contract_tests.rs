    ...
    for (realized, portable) in [
        ...
        (
            ...
            portable_required_text_offer(
                conduit_semantic_catalog::text_join_contract(),
...
fn portable_music_synth_offer() -> conduit_core::CapabilityOffer {
    conduit_semantic_catalog::realization_offer(
        conduit_semantic_catalog::music_synth_contract(),
...
fn portable_offer(
    ...
    conduit_semantic_catalog::realization_offer(
        ...
        revision,
        conduit_semantic_catalog::RealizationOfferIdentity {
            capability: "conduitos-test/portable-front",
            execution_profile: "conduitos-test/portable-front@1",
            implementation: "conduitos-test/portable-front@1",
            artifact: "conduitos-test/portable-front@1",
        },
        Vec::new(),
        Vec::new(),
        Vec::new(),
