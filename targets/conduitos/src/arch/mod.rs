...
#[cfg(target_arch = "x86_64")]
pub use x86_64::{
    Clock, HidError, HidKeyTransition, HidKeyboardSession, HidPointerError, HidPointerReady,
    HidPointerSession, HidProof, Idle, Interrupts, Opl2, PcSpeaker, RebootBase, RebootError,
    ...
    pc_speaker_input_hz, prepare_boot_keyboard, prepare_boot_pointer, receive_boot_keyboard,
    receive_first_boot_keyboard_report, retire_removed_device, run_boot_keyboard,
    start_boot_keyboard_session, start_pointer_session, wait_for_attachment_state,
};
