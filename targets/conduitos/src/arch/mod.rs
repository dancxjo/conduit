...
pub use x86_64::{
    ...
    Ps2Input, Ps2Ready, RebootBase, RebootError, Serial, Timer, UsbDevice, XhciReady, boot_entropy,
    ...
    retire_removed_device, run_boot_keyboard, start_boot_keyboard_session, start_ftdi_line_session,
