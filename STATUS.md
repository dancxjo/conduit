...
This is `freestanding-emulator` proof only: USB device enumeration, HID report
parsing, key events, keymaps, chords, hotplug, external transport, physical
devices, and HIL remain unclaimed and owned by later #804 milestones.
