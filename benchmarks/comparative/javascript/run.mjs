...
function runIdentitySample(sampleKind, trial, thermalState) {
  ...
  return {
    ...
    workload: {
      ...
      payload_bytes: 0,
      payload_representation: "native-number",
      watch_slots: 0,
    ...
    memory: {
      ...
      value_resident_slots_after_terminal: null,
      value_resident_bytes_after_terminal: null,
      value_slots_high_water: null,
      value_bytes_high_water: null,
      value_slots_capacity: null,
      value_bytes_capacity: null,
      host_io_capacity_bytes: null,
      host_io_output_bytes: null,
      watch_admitted_slots: null,
      watch_attached_slots: null,
      watch_retained_observations: null,
      watch_retained_preview_bytes: null,
      watch_dropped_observations: null,
      watch_maximum_observations: null,
      watch_maximum_preview_bytes: null,
    },
