...
// The installed browser profile has 74 offers and encodes to less than 76 KiB
...
pub const MAX_CANDIDATE_ADVERTISEMENT_BYTES: u32 = 80 * 1024;
...
pub const MAX_CANDIDATE_CAPABILITIES: usize = 80;
