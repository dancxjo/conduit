...
pub const DESCRIPTOR_RELATIVE_PATH: &str =
    "firmware/conduit-esp32-wroom-signal/architecture-package.json";
pub const PACKAGE_RELATIVE_PATH: &str = "firmware/conduit-esp32-wroom-signal";

#[derive(Debug, Clone, Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub struct ArchitecturePackageDescriptor {
    pub schema: String,
    pub package: String,
    pub revision: u32,
    pub chip: String,
...
impl ArchitecturePackageDescriptor {
    ...
    pub fn validate(
        ...
        if self.schema != "conduit.architecture-package/esp32-firmware@1"
        ...
        {
            return Err("exact ESP32 architecture-package descriptor identity refused".into());
        }
...
mod tests {
    ...
    fn descriptor() -> ArchitecturePackageDescriptor {
        ArchitecturePackageDescriptor {
    ...
    #[test]
    fn exact_revision_two_descriptor_is_accepted() {
        descriptor()
