...
```sh
CONDUIT_BROWSER_HOST_PORT=4173 CONDUIT_BROWSER_PROOF_SHARD=tour npx playwright test --config proof/browser/playwright.config.mjs proof/browser/executable-tour.spec.mjs --workers=1 --retries=0
