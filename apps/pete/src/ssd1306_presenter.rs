...
pub const SSD1306_PRESENTER_IMPLEMENTATION: &str = "pete/presenter-ssd1306-128x32@1";
pub const SSD1306_PRESENTER_CAPABILITY: &str = "pete/presenter-ssd1306@1";
pub const SSD1306_PRESENTER_PROFILE: &str = "pete/ssd1306-product@1";
pub const SSD1306_PRESENTER_ARTIFACT: &str = "conduit-pete/ssd1306-presenter@1";
pub const SSD1306_PRESENT_OPERATION: &str = "conduit.host/present-ssd1306@1";
pub const SSD1306_I2C_RESOURCE: &str = "pete.resource/ssd1306-i2c-base@1";
    ...
    pub fn present<P: Ssd1306I2cProvider>(
        ...
        let manifestation = if device_failure.is_none() {
            prepared.transition(
                ...
                SignId::from(format!(
                    "pete/ssd1306/manifestation-available/{}",
                    presentation.revision
                )),
            )
        } else {
            prepared.fail(
                ...
                SignId::from(format!(
                    "pete/ssd1306/manifestation-failed/{}",
                    presentation.revision
                )),
            )
        }
