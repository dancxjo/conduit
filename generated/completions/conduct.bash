_conduct() {
    ...
    case "${cmd}" in
        conduct)
            opts="-q -v -h -V --check --explain --run --format --diagnostic-format --color --quiet --verbose-diagnostics --compile-input --compatibility-demo --enable-file-write --enable-file-watch --enable-storage-cache --enable-media-ffmpeg --enable-media-sox --enable-process-exec --enable-socket-loopback --enable-http-client-loopback --help --version inspect compile package capsule"
