...
function renderBodyWorkbench(workbench){
  ...
  const active=new Set(current.active_forms.map(form=>form.checked_form_id)),available=workbench.reviewed_forms.filter(form=>!active.has(form.checked_form_id));
