...
if test "$mode" = release; then
  ...
  for artifact in hosted-linux-x86_64.json conduit-linux-x86_64 conduit-tour-linux-x86_64 conduit-home-linux-x86_64 install-linux-x86_64.sh hosted-windows-x86_64.json conduit-windows-x86_64.exe conduit-tour-windows-x86_64.exe conduit-home-windows-x86_64.exe hosted-macos-aarch64.json conduit-macos-aarch64 conduit-home-macos-aarch64 install-macos-aarch64.sh browser-page.json runtime.wasm index.html host.mjs browser-host-bootstrap.mjs browser-host-membership.mjs browser-host-identity.mjs browser-boot-profile.mjs media-host.mjs device-base.mjs usb-device-base.mjs; do
