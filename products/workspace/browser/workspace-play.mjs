...
export function openWorkspacePlay({ host, session, source, inputTarget, outputRoot, onState }) {
  ...
  return Object.freeze({
    async wake() {
      ...
      try {
        ...
        adapter = acquireBrowserBodyHost({ api: host.runtime, hostId: host.hostId, bootId: host.bootId, proposal, inputTarget, outputRoot });
