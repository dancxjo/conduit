...
for asset in creche-names.mjs creche-rendezvous.mjs rendezvous-cbor.mjs creche-rendezvous-candidates.mjs creche-physical.mjs creche-physical-presentation.mjs creche-target-catalog.mjs creche-existing-computer.mjs creche-release-catalog.mjs creche-release-bundle.mjs creche-spore-bundle.mjs creche-native-zip.mjs; do
