...
cp products/workspace/browser/workspace.css products/workspace/browser/resident-tour.css products/workspace/browser/workspace.mjs products/workspace/browser/workspace-session.mjs products/workspace/browser/workspace-membership.mjs products/workspace/browser/workspace-play.mjs products/workspace/browser/workspace-library.mjs products/workspace/browser/workspace-handoff.mjs products/workspace/browser/workspace-surface.mjs "$destination/"
...
for asset in browser-host-operations.mjs browser-audio-cue.mjs browser-pcm-audio.mjs browser-body-host.mjs browser-body-input.mjs browser-body-continuity.mjs browser-human-input.mjs browser-form-effects.mjs browser-application-loader.mjs browser-application-storage.mjs browser-host-bootstrap.mjs browser-host-membership.mjs browser-host-identity.mjs application-presentation.mjs application-theme.mjs application-syntax-presentation.mjs; do
