...
function requireSnapshot(value) {
  ...
  if(value.authoring&&(!Array.isArray(value.authoring.palette)||value.authoring.palette.length>68||typeof value.authoring.source_document_id!=="string"||typeof value.authoring.expanded_form_id!=="string"||!Number.isSafeInteger(value.authoring.source_revision)))throw new Error("malformed bounded authoring projection");
