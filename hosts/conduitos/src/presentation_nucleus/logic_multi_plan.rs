...
pub struct PreparedLogicMulti {
    ...
    pub(super) comparison: conduit_semantic_catalog::ScalarComparison,
}
...
pub fn prepare_logic_multi(
    ...
    let operator = match comparison {
        conduit_semantic_catalog::ScalarComparison::Less => "lt",
        conduit_semantic_catalog::ScalarComparison::LessOrEqual => "le",
        conduit_semantic_catalog::ScalarComparison::Equal => "eq",
        conduit_semantic_catalog::ScalarComparison::NotEqual => "ne",
        conduit_semantic_catalog::ScalarComparison::GreaterOrEqual => "ge",
