...
The lightweight package contribution is in `../fabrication-package`. It advertises the finite x86_64, IA-32, AArch64, RISC-V64, and LoongArch64 targets without loading or running their builders during inspection.
