...
compile_error!("the shared ConduitOS RISC-V64 A3/A4 implementation must compile as RISC-V64");
...
#[unsafe(no_mangle)]
#[unsafe(link_section = ".text.conduitos_riscv64_a3_start")]
pub extern "C" fn conduitos_riscv64_a3_start() -> ! {
    unsafe {
        BOOT_ARENA
            .initialize(
...
fn entry_sign(nonce: u64) {
    ...
    output.hex(nonce.rotate_left(13) ^ 0x434f_4e44_5549_5403);
    output.push(b"\",\"boot_id\":\"boot-riscv64-");
    output.hex(nonce ^ 0x5256_3634_0000_0003);
