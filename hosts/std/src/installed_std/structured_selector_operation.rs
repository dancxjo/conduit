...
pub(super) struct StructuredSelectorOperation {
        ...
        match input {
            OperationInput::Value {
                ...
                let Some(next_request) = self.next_request.checked_add(1) else {
                    return InstalledOperation::fail(140);
                };
                ...
                let Ok(input) =
                    ...
                    return InstalledOperation::fail(141);
                };
