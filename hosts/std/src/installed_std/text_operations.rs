...
use conduit_std_catalog::{
    MAX_TEXT_VALUES, TEXT_JOIN_ARTIFACT, TEXT_JOIN_EXECUTION_PROFILE, TEXT_JOIN_IMPLEMENTATION,
    ...
    TEXT_PRESENTATION_VALUE_KIND, TEXT_UPPER_ARTIFACT, TEXT_UPPER_EXECUTION_PROFILE,
