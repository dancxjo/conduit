...
fn write_root_index(root: &Path, index: &GalleryIndex, has_conduitos: bool) -> Result<(), String> {
    ...
    let body = format!(
        "<header class=\"gallery-hero\"><p class=\"eyebrow\">The flagship Conduit demonstration</p><h1>One Journey. Three Bodies.</h1><p class=\"lede\">One semantic tutorial is lived independently through a native ConduitOS Body, a browser Body, and a distributed conversational Body. Read down to follow one life, or across to compare the same meaning through radically different machinery.</p></header><!-- conduit-three-body-flagship@1:start --><section class=\"flagship pending\" aria-labelledby=\"flagship-title\"><p class=\"eyebrow\">Publication status · evidence not yet admitted</p><h2 id=\"flagship-title\">The comparison has a place before it has a claim</h2><p>The shared contract is ready, but this accepted commit does not contain three verified production tracks. Empty cells are explicit; no adjacent proof is promoted into the Journey.</p><div class=\"journey-matrix\" role=\"table\" aria-label=\"Three-Body Journey evidence status\"><div role=\"row\" class=\"matrix-head\"><span role=\"columnheader\">Semantic life</span><span role=\"columnheader\">Body A<br>ConduitOS</span><span role=\"columnheader\">Body B<br>Browser</span><span role=\"columnheader\">Body C<br>Distributed</span></div><div role=\"row\"><strong role=\"rowheader\">Birth → Wake → Use → Inspect → Change → Replan → Add Host → Fault → Repair → Continue → Lull → Fulfill</strong><span role=\"cell\">Evidence not yet admitted</span><span role=\"cell\">Evidence not yet admitted</span><span role=\"cell\">Evidence not yet admitted</span></div></div><p class=\"boundary\"><strong>No simulated biography.</strong> This space becomes an accepted Journey only after all three exact-commit tracks pass the shared verifier.</p></section><!-- conduit-three-body-flagship@1:end --><section class=\"other-evidence\" aria-labelledby=\"other-evidence-title\"><p class=\"eyebrow\">Other evidence</p><h2 id=\"other-evidence-title\">Smaller proofs, each with its own boundary</h2><p>These exhibits establish useful pieces of Conduit behavior. They are not substitutes for the flagship Journey.</p><div class=\"cards\">{audio_card}{two_fronts_card}{little_life_card}{conduitos_card}</div></section><details class=\"history\"><summary>All accepted evidence and history</summary><p>Current accepted main: <code>{}</code></p>{patchbay}{conduitos}{hears_speaks}{two_fronts}{little_life}<ul>{history}</ul><p>History retains the latest {RETAINED_COMMITS} published main commits. Semantic proof remains authoritative; media are documentary evidence.</p></details>",
