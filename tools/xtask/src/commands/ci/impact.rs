...
const CONTROLLER_PROOFS: &[ControllerProofSpec] = &[
    ...
    ControllerProofSpec {
        ...
        implementation_inputs: &[
            ...
            "tools/xtask/src/commands/ci/integration.rs",
            "tools/xtask/src/commands/ci/integration/tests.rs",
            "tools/xtask/src/commands/ci/impact.rs",
            "tools/xtask/src/commands/ci/impact/tests.rs",
            "tools/xtask/src/commands/ci/proof_graph.rs",
    ...
    ControllerProofSpec {
        ...
        implementation_inputs: &[
            ...
            "tools/xtask-dispatch/src/ci_dispatch.rs",
            "tools/xtask/src/commands/ci.rs",
            "tools/xtask/src/commands/ci/monitor.rs",
        ],
        ...
        required_inputs: &["tools/xtask/src/commands/ci/monitor.rs"],
        workspace_packages: &["conduit-xtask-dispatch", "xtask"],
    },
    ControllerProofSpec {
...
fn plan_for_paths(
    ...
    let tongues_analysis_slice = substantive
        ...
        && substantive
            .iter()
            .any(|path| path.as_str() == "tools/xtask/src/commands/tongues.rs");
