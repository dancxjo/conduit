...
pub(super) const PROOFS: &[ProofSpec] = &[
    ProofSpec {
        ...
        implementation_inputs: &["proof/ci", "tools/xtask/tests/ci_workflow_contract.rs"],
        consumed_artifacts: &[],
    ...
    ProofSpec {
        ...
        implementation_inputs: &["tools/xtask/src/suites/workspace_shards.rs", ".github/workflows/check.yml"],
        consumed_artifacts: &[],
    ...
    ProofSpec {
        ...
        implementation_inputs: &["tools/xtask/src/commands/esp32_firmware.rs", ".github/workflows/check.yml"],
        consumed_artifacts: &[],
    ...
    ProofSpec {
        ...
        implementation_inputs: &[
            "tools/xtask/src/commands/esp32_firmware.rs",
            ".github/workflows/check.yml",
        ],
        consumed_artifacts: &[],
    ...
    ProofSpec {
        ...
        contract_version: 1,
        kind: ProofKind::Machine,
        inputs: &["targets/conduitos/fabrication/tools/xtask/profile.rs"],
        implementation_inputs: &[".github/workflows/check.yml"],
        consumed_artifacts: &[],
