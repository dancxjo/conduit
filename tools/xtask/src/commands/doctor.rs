...
fn browser_probes() -> Vec<ProbeSpec> {
    vec![
        probe(
            ...
            Some("npm --prefix proof/browser ci --ignore-scripts"),
        ),
        probe(
            "browser",
            ...
            Some("node proof/browser/node_modules/@playwright/test/cli.js install chromium"),
        ),
        probe(
            "browser",
            ...
            Some("node proof/browser/node_modules/@playwright/test/cli.js install firefox"),
        ),
    ]
}
