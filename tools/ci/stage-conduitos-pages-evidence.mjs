...
const JOURNEY = Object.freeze([
  ...
  stage("workload-revised", "Workload revised", "The Body reports a new exact workload revision after admitting another resident Form.", "The ordinary product action admitted the reviewed Form into the same Body biography.", "The retained revision and sign establish a workload change without inventing a new Body.", "Body · Form · workload revision · Sign", "Admit Form"),
  stage("workload-replanned", "Workload replanned", "The revised workload is realized by a fresh exact Plan and Play.", "The Body replanned its admitted work after the workload revision.", "The replacement Plan and Play are correlated with the same Body and revised workset.", "Body · workset · Plan · Play", "Replan"),
  ...
  stage("fulfilled", "Body Fulfilled", "The Body biography is visibly closed after its explicit terminal lifecycle action.", "The ordinary Fulfill action irreversibly ended the retained Body after its work was complete.", "The exact fulfilled sign and biography state establish terminal closure, distinct from Lull or generated readiness prose.", "Body · Fulfill · biography · Sign", "Fulfill"),
