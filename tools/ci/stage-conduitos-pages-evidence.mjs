...
const JOURNEY = Object.freeze([
  ...
  stage("playing", "Play inspected", "The same Play remains active after its exact details have been inspected.", "F2 opened details; Escape returned input focus to the Form.", "Inspection preserves the current Play and does not send its control keys into the Form.", "Plan · Play · focus", "F2 / Escape"),
  stage("result-visible", "Result visible", "The presentation shows HELLO while the same Form keeps listening.", "Five keys crossed the admitted keyboard path, each with a press and release, and flowed through the Form.", "Every event retains the same Body, Plan, and Play; output is correlated with the port-specific kernel result.", "Form · Play · presentation", "H E L L O"),
