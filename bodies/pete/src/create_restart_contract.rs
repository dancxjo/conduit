...
pub const CREATE_RESTART_SERVICE_AUTHORITY: &str = "pete.authority/create1-restart-service@1";
pub const CREATE_RESTART_SERVICE_IMPLEMENTATION: &str = "pete/create1-restart-service@1";
