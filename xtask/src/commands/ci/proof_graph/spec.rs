...
pub(super) const PROOFS: &[ProofSpec] = &[
    ...
    conduitos_proof!("conduitos.x86.kernel", Selection::ConduitosX86("kernel"), "ubuntu-qemu-x86_64-kernel-v1", "cargo xtask conduitos prove --arch x86-64 --locked"),
    conduitos_proof!("conduitos.x86.xhci", Selection::ConduitosX86("xhci"), "ubuntu-qemu-x86_64-xhci-v1", "cargo xtask conduitos xhci-proof --prepared-image --locked"),
    conduitos_proof!("conduitos.x86.usb", Selection::ConduitosX86("usb"), "ubuntu-qemu-x86_64-usb-v1", "cargo xtask conduitos usb-proof --prepared-image --locked"),
    conduitos_proof!("conduitos.x86.hid", Selection::ConduitosX86("hid"), "ubuntu-qemu-x86_64-hid-v1", "cargo xtask conduitos hid-proof --prepared-image --locked"),
    conduitos_proof!("conduitos.x86.keyboard", Selection::ConduitosX86("keyboard"), "ubuntu-qemu-x86_64-keyboard-v1", "cargo xtask conduitos keyboard-proof --prepared-image --locked"),
    conduitos_proof!("conduitos.x86.front-door", Selection::ConduitosX86("front-door"), "ubuntu-qemu-x86_64-front-door-v1", "cargo xtask conduitos front-door-proof --locked"),
    conduitos_proof!("conduitos.x86.product-journey", Selection::ConduitosX86("product-journey"), "ubuntu-qemu-x86_64-product-journey-v1", "cargo xtask conduitos journey-proof --locked"),
    conduitos_proof!("conduitos.x86.rescue", Selection::ConduitosX86("rescue"), "ubuntu-qemu-x86_64-rescue-v1", "cargo xtask conduitos rescue-proof --prepared-image --locked"),
    ...
    conduitos_proof!("conduitos.aarch64-product", Selection::ConduitosAarch64Product, "ubuntu-qemu-aarch64-product-v1", "cargo xtask host build profiles/hosts/conduitos-aarch64-headless.profile.json --locked"),
];
