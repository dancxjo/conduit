...
pub const RHYTHM_STATE_SOURCE_KIND: &str = "time/rhythm-state";
pub const PULSE_OBSERVE_REVISION: &str = "conduit.std/time-pulse-observe@3";
pub const PHASE_SYNCHRONIZE_REVISION: &str = "conduit.std/time-phase-synchronize@1";
pub const RHYTHM_STATE_SOURCE_REVISION: &str = "conduit.time/rhythm-state-source@1";
