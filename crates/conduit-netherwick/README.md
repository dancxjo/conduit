...
The historical Pete Brainstem revision and its responsibility migration ledger
remain recorded in `docs/architecture/netherwick-brainstem-migration.md`. The old
