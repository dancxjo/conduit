...
pub const CREATE_MODE_SERVICE_AUTHORITY: &str = "netherwick.authority/create1-mode-service@1";
pub const CREATE_MODE_SERVICE_IMPLEMENTATION: &str = "netherwick/create1-oi-mode-service@1";
pub const CREATE_MODE_SERVICE_ATTACHMENT: &str = "netherwick.resource/create1-mode-service@1";
