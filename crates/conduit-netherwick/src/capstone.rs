...
pub const NETHERWICK_CAPSTONE_FORM_NAME: &str = "netherwick-capstone";
pub const CAPSTONE_SERIALIZED_CLIENT_RESOURCE: &str =
    "netherwick.resource/create1-serialized-operation-client@1";
pub const CAPSTONE_WATCHDOG_RESOURCE: &str = "netherwick.resource/independent-watchdog@1";
pub const CAPSTONE_TRANSLATOR_RESOURCE: &str = "netherwick.resource/level-translator@1";
pub const CAPSTONE_STD_PROFILE: &str = "netherwick/std-create1-capstone@1";
pub const CAPSTONE_PICO_PROFILE: &str = "netherwick/pico-create1-capstone@1";
pub const CAPSTONE_STD_VELOCITY_IMPLEMENTATION: &str = "netherwick/std-velocity-intent@1";
pub const CAPSTONE_PICO_VELOCITY_IMPLEMENTATION: &str = "netherwick/pico-velocity-intent@1";
pub const CAPSTONE_STD_SELECT_IMPLEMENTATION: &str = "netherwick/std-state-select@1";
pub const CAPSTONE_PICO_SELECT_IMPLEMENTATION: &str = "netherwick/pico-state-select@1";
pub const CAPSTONE_ARTIFACT: &str = "conduit-netherwick/capstone-kernel@1";
pub const CAPSTONE_DRIVE_GRANT: &str = "grant/netherwick-capstone-drive";
...
pub fn capstone_plan(
    ...
    let (_, profile) = crate::catalogs().expect("fixed Netherwick catalogs are valid");
    let checked = conduit_form::parse(NETHERWICK_CAPSTONE_FORM, &profile)
...
pub const NETHERWICK_CAPSTONE_FORM: &str = r#"form netherwick-capstone {
...
mod tests {
    ...
    fn evidence(class: CapstoneHostClass) -> CapstoneHostEvidence {
        ...
        let robot = "device/netherwick-create1";
    ...
    fn capstone_source_is_canonical_and_contains_no_realization_facts() {
        for forbidden in [
            ...
            assert!(!NETHERWICK_CAPSTONE_FORM
                .to_ascii_lowercase()
                .contains(forbidden));
        }
        let (startup, profile) = crate::catalogs().unwrap();
        let syntax = conduit_form::parse_syntax_document(NETHERWICK_CAPSTONE_FORM);
        let checked = conduit_form::check_syntax_document(&syntax, &startup).unwrap();
        let expanded =
            conduit_form::expand_canonical_form(&checked, NETHERWICK_CAPSTONE_FORM_NAME, &profile)
                .unwrap();
