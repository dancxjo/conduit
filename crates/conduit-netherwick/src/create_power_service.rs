...
pub const CREATE_POWER_SERVICE_AUTHORITY: &str = "netherwick.authority/create1-power-toggle@1";
pub const CREATE_POWER_SERVICE_IMPLEMENTATION: &str = "netherwick/create1-power-toggle-service@1";
pub const CREATE_POWER_SERVICE_ATTACHMENT: &str =
    "netherwick.resource/create1-translated-power-toggle@1";
