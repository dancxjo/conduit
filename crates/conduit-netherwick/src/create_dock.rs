...
pub const CREATE_DOCK_CAPABILITY: &str = "netherwick/create1/dock";
pub const CREATE_DOCK_IMPLEMENTATION: &str = "netherwick/create1-seek-dock@1";
pub const CREATE_DOCK_ARTIFACT: &str = "conduit-netherwick/create1-dock@1";
pub const CREATE_DOCK_OPERATION: &str = "netherwick.host/create1-dock@1";
pub const CREATE_DOCK_AUTHORITY: &str = "netherwick.authority/create1-dock@1";
pub const CREATE_DOCK_REDUCED_SAFETY_AUTHORITY: &str =
    "netherwick.authority/create1-dock-no-independent-watchdog@1";
pub const CREATE_DOCK_PROFILE: &str = "netherwick/create1-dock@1";
pub const CREATE_DOCK_REDUCED_SAFETY_PROFILE: &str =
    "netherwick/create1-dock-no-independent-watchdog@1";
pub const CREATE_DOCK_RESOURCE: &str = "netherwick.resource/create1-dock@1";
pub const CREATE_DOCK_GRANT: &str = "grant/netherwick-create1-dock";
...
pub fn live_create_dock_advertisement(
    ...
    toggle.capability_id = CapabilityId::from("netherwick/create1-dock-request@1");
