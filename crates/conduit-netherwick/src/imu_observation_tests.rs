...
fn evidence() -> Mpu6050Evidence {
    Mpu6050Evidence {
        host_id: HostId::from("host/pico-netherwick"),
        boot_id: BootId::from("boot/pico-netherwick"),
        offer_generation: OfferGeneration(7),
        i2c_base_id: "base/pico-i2c1-gp2-gp3".into(),
        attachment_id: "attachment/netherwick-mpu6050".into(),
        session_resource_id: "session/netherwick-mpu6050".into(),
        body_frame_id: "frame/netherwick-body-forward-left-up".into(),
        mounting_id: "mounting/netherwick-r23-mpu6050-v1".into(),
        address: 0x68,
