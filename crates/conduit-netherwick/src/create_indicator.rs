...
pub const INDICATOR_CAPABILITY: &str = "netherwick/create1-show-signal@1";
pub const INDICATOR_PROFILE: &str = "netherwick/create1-oi-power-indicator@1";
pub const INDICATOR_IMPLEMENTATION: &str = "netherwick/create1-oi-power-led-show@1";
pub const INDICATOR_ARTIFACT: &str = "conduit-netherwick/create1-oi-indicator@1";
pub const INDICATOR_RESOURCE: &str = "netherwick.resource/create1-indicator@1";
pub const INDICATOR_GRANT: &str = "grant/netherwick-create1-indicator-present";
...
pub fn live_indicator_advertisement(
    ...
    pulse.capability_id = CapabilityId::from("netherwick/create1-indicator-pulse@1");
