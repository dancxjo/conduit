use crate::{
    ...
    CREATE_DRIVE_PROFILE, CREATE_DRIVE_RESOURCE, CREATE_UART_BASE_RESOURCE,
};
use conduit_core::{
...
pub(super) fn validate_create_drive_plan(
    ...
    if placement.host_id != evidence.host_id
        ...
        || placement.execution_profile_id.as_str() != CREATE_DRIVE_PROFILE
    ...
    if authority.contract_id.as_str() != CREATE_DRIVE_AUTHORITY
