...
pub const MPU6050_PROFILE: &str = "netherwick/mpu6050-observation@1";
pub const MPU6050_CAPABILITY: &str = "netherwick/mpu6050/orientation";
pub const MPU6050_IMPLEMENTATION: &str = "netherwick/mpu6050-observe-imu@1";
pub const MPU6050_ARTIFACT: &str = "conduit-netherwick/mpu6050-observation@1";
pub const MPU6050_OPERATION: &str = "netherwick.host/mpu6050-observe-imu@1";
pub const I2C_BASE_RESOURCE: &str = "netherwick.resource/i2c-base@1";
pub const MPU6050_ATTACHMENT_RESOURCE: &str = "netherwick.resource/mpu6050-attachment@1";
pub const MPU6050_SESSION_RESOURCE: &str = "netherwick.resource/mpu6050-session@1";

pub const MPU6050_FORM: &str = r#"form netherwick_imu {
