...
pub const CREATE_OBSERVATION_PROFILE: &str = "netherwick/create1-correlated-observation@1";
pub const CREATE_OBSERVATION_ARTIFACT: &str = "conduit-netherwick/create1-observation@1";
pub const CREATE_OBSERVATION_RESOURCE: &str = "netherwick.resource/create1-observation-session@1";
...
impl CreateObservationChannel {
    ...
    pub const fn implementation_id(self) -> &'static str {
        match self {
            Self::Contact => "netherwick/create1-observe-contact@1",
            Self::Cliff => "netherwick/create1-observe-cliff@1",
            Self::WheelDrop => "netherwick/create1-observe-wheel-drop@1",
            Self::Proximity => "netherwick/create1-observe-proximity@1",
            Self::VirtualWall => "netherwick/create1-observe-virtual-wall@1",
            Self::Infrared => "netherwick/create1-observe-infrared@1",
    ...
    pub const fn operation_id(self) -> &'static str {
        match self {
            Self::Contact => "netherwick.host/create1-observe-contact@1",
            Self::Cliff => "netherwick.host/create1-observe-cliff@1",
            Self::WheelDrop => "netherwick.host/create1-observe-wheel-drop@1",
            Self::Proximity => "netherwick.host/create1-observe-proximity@1",
            Self::VirtualWall => "netherwick.host/create1-observe-virtual-wall@1",
            Self::Infrared => "netherwick.host/create1-observe-infrared@1",
    ...
    const fn capability_id(self) -> &'static str {
        match self {
            Self::Contact => "netherwick/create1/contact",
            Self::Cliff => "netherwick/create1/cliff",
            Self::WheelDrop => "netherwick/create1/wheel-drop",
            Self::Proximity => "netherwick/create1/proximity",
            Self::VirtualWall => "netherwick/create1/virtual-wall",
            Self::Infrared => "netherwick/create1/infrared",
