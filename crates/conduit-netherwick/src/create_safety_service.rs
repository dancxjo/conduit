...
pub const CREATE_SAFETY_CLEAR_AUTHORITY: &str = "netherwick.authority/create1-safety-clear@1";
pub const CREATE_SAFETY_ENVELOPE_IMPLEMENTATION: &str =
    "netherwick/create1-local-safety-envelope@1";
