...
pub const IMU_CALIBRATION_AUTHORITY: &str = "netherwick.authority/imu-calibration@1";
pub const IMU_CALIBRATION_SERVICE: &str = "netherwick/mpu6050-calibration-service@1";
