...
pub fn bool_presentation_browser_offer() -> CapabilityOffer {
    ...
    CapabilityOffer {
        ...
        shorthand: None,
        capability_id: CapabilityId::from(BOOL_PRESENTATION_CAPABILITY),
        kind_id: contract.kind_id,
        kind_contract_revision: KindContractRevision::from(BOOL_PRESENTATION_CONTRACT_REVISION),
        implementation: conduit_core::ImplementationOffer {
            execution_profile_id: ExecutionProfileId::from(BOOL_PRESENTATION_EXECUTION_PROFILE),
            implementation_id: ImplementationId::from(BOOL_PRESENTATION_IMPLEMENTATION),
            artifact_id: ArtifactId::from(BOOL_PRESENTATION_ARTIFACT),
        },
        inputs: contract.inputs,
        outputs: contract.outputs,
        host_operations: vec![present_host_operation_requirement(
            kind_id(BOOL_PRESENTATION_TARGET),
...
mod tests {
    ...
    fn bool_presenter_is_exact_current_boolean_to_admitted_effect() {
        let contract = bool_presentation_contract();
        let offer = bool_presentation_browser_offer();
