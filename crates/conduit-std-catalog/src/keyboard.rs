...
use alloc::vec::Vec;
use conduit_core::{
    kind_id, port_id, resource_requirement, CapabilityLimits, HostOperationContractId,
    HostOperationRequirement, KindContractRevision, PortDescriptor, PortDirection, PortTemporal,
    ResourceRequirement, INPUT_RESOURCE_CLASS, KEY_EVENT_ENCODED_LEN, KEY_EVENT_INFO_ID,
};
