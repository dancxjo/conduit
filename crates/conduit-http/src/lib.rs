...
mod tests {
    ...
    fn exact_http_binding_rejects_destination_resource_and_binding_mismatch() {
        ...
        let mut exact = ExactHostedServiceBinding {
            plan_identity: conduit_core::SemanticHash::from_bytes([1; 32]),
            plan_epoch: 0,
            ...
            authorities: vec![ExactHostedServiceAuthority {
                ...
                resource_lease_identity: conduit_core::SemanticHash::from_bytes([2; 32]),
                resource_lease_run_id: "conduit/conduct-run".to_owned(),
                resource_lease_epoch: 0,
                resource_lease_time_basis: "clock/conduct-host".to_owned(),
                commit_profile_identity: conduit_core::SemanticHash::from_bytes([3; 32]),
                resource_lease: conduit_runtime::ExactResourceLeaseBinding {
                    identity: conduit_core::SemanticHash::from_bytes([2; 32]),
                    schema_version: conduit_core::RESOURCE_LEASE_SCHEMA_VERSION,
                    id: "lease/http-loopback".to_owned(),
                    resource_binding: super::HTTP_CLIENT_LOOPBACK_RESOURCE.to_owned(),
                    holder: "client".to_owned(),
                    run: "conduit/conduct-run".to_owned(),
                    epoch: 0,
                    scope: "conduit.scope/http-loopback".to_owned(),
                    sharing: conduit_core::ResourceSharingMode::Exclusive,
                    reservation: conduit_core::PlanResourceBudget {
                        memory_bytes: 1,
                        ..conduit_core::PlanResourceBudget::ZERO
                    },
                    ...
                    maximum_evidence_events: 2,
                    cleanup_escalation: conduit_runtime::ExactPinnedDescriptor {
                        id: "conduit.cleanup/http-loopback".to_owned(),
                        schema_version: 0,
                        semantic_hash: conduit_core::SemanticHash::from_bytes([4; 32]),
                    },
                    foreign_retention: conduit_core::ForeignRetention::Unsupported,
                },
                commit_profile: conduit_runtime::ExactEffectCommitBinding {
                    identity: conduit_core::SemanticHash::from_bytes([3; 32]),
                    schema_version: conduit_core::EFFECT_COMMIT_PROFILE_SCHEMA_VERSION,
                    id: "conduit.effect-profile/http-loopback".to_owned(),
                    operation: "conduit.action/request".to_owned(),
                    resource_lease: "lease/http-loopback".to_owned(),
                    commit_boundary: conduit_runtime::ExactPinnedDescriptor {
                        id: "conduit.commit/http-loopback".to_owned(),
                        schema_version: 0,
                        semantic_hash: conduit_core::SemanticHash::from_bytes([5; 32]),
                    },
                    idempotency: conduit_core::EffectIdempotency::ReconcileBeforeRetry,
                    unknown_commit: conduit_core::UnknownCommitPolicy::Reconcile,
                    discontinuity: conduit_core::EffectDiscontinuity::ReconcileRequired,
                    cleanup: conduit_runtime::ExactPinnedDescriptor {
                        id: "conduit.cleanup-profile/http-loopback".to_owned(),
                        schema_version: 0,
                        semantic_hash: conduit_core::SemanticHash::from_bytes([6; 32]),
                    },
                    maximum_attempts: 1,
