...
use conduit_compile::{
    ...
    CompileSourceLimits, ExecutionLaneObservationDocument, ExecutionLimitsDocument,
    ExecutionPlacementObservationDocument, ExecutionProfileDocument, HostReportDocument,
...
fn candidate(ordinal: u8, contract_id: &str, contract_hash: SemanticHash) -> CandidateDocument {
    ...
    CandidateDocument {
        ...
        host_report: HostReportDocument {
            ...
            boot_id: "fixture/browser-worker-boot".to_owned(),
            ...
            execution_placements: vec![ExecutionPlacementObservationDocument {
                id: format!("placement/browser-{ordinal}"),
                provider: pin("provider/fixed-browser-lanes", 52),
                authority_boundary: pin("boundary/browser-authority", 53),
                resource_boundary: pin("boundary/browser-resource", 54),
                lifecycle_boundary: pin("boundary/browser-lifecycle", 55),
                failure_boundary: pin("boundary/browser-failure", 56),
                generation: 1,
            ...
            execution_lanes: vec![ExecutionLaneObservationDocument {
                id: format!("lane/browser-{ordinal}"),
                placement: format!("placement/browser-{ordinal}"),
...
pub fn browser_compile_input(source: &str) -> CompileInput {
    ...
    let mut input = CompileInput {
        ...
        execution_arrangement: conduit_compile::fixed_hosted_execution_arrangement_policy(),
