...
const NODE_CONTRACT_HEX: &str = "";
const NODE_CONTRACT_HASH: &str =
    "sha256:d5867485ff961789393f9553dce2d3794f5f36678df9bd2c8603dc8319ae0d40";
const SCALAR_HEX: &str = "";
const SCALAR_HASH: &str = "sha256:f18ea35bc600ad01bd5e9009d53d0547f0256fd7e068784a7beac02670ac2eb4";
...
fn node_contract_matches_frozen_vector_and_normalizes_order() {
    let input_fields = [
        ...
        semantic(
            "value_type",
            CanonicalValue::Identifier(Id("conduit/text.utf8")),
        ),
    ...
    let fields = [
        ...
        semantic("id", CanonicalValue::Identifier(Id("conduit/uppercase"))),
    ];
